...
class TealiumCollectTests: XCTestCase {
    ...
    func validTestDataDictionary() -> [String:AnyObject] {
        ...
        return [
            ...
            TealiumKey.sessionId : "someSessionId" as AnyObject,
            TealiumKey.visitorId :"someVisitorId" as AnyObject,
            TealiumKey.visitorIdDeprecated :"someVisitorId" as AnyObject,
            TealiumKey.legacyVid : "someVID" as AnyObject,
            TealiumKey.random :"someRandomNumber" as AnyObject
        ]
...
//        let expectedURL = "https://collect.tealiumiq.com/vdata/i.gif?event_name=eventName&tealium_account=account&tealium_environment=environment&tealium_library_name=swift&tealium_library_version=1.0.0&tealium_profile=profile&tealium_random=someRandomNumber&tealium_session_id=someSessionId&tealium_vid=someVID&tealium_visitor_id=someVisitorId"
        let expectedURL = "https://collect.tealiumiq.com/vdata/i.gif?event_name=eventName&tealium_account=account&tealium_environment=environment&tealium_event=test&tealium_event_type=activity&tealium_firstparty_visitor_id=someVisitorId&tealium_library_name=swift&tealium_library_version=1.1.0&tealium_profile=profile&tealium_random=someRandomNumber&tealium_session_id=someSessionId&tealium_vid=someVID&tealium_visitor_id=someVisitorId"
