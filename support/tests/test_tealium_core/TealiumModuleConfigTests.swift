...
class TealiumModuleConfigTests: XCTestCase {
    ...
    let configA = TealiumModuleConfig(name: "a", priority: 100, enabled: true)
    let configA2 = TealiumModuleConfig(name: "a", priority: 100, enabled: true)
    let configB = TealiumModuleConfig(name: "b", priority: 100, enabled: true)
    let configC = TealiumModuleConfig(name: "a", priority: 101, enabled: true)
    let configD = TealiumModuleConfig(name: "a", priority: 100, enabled: false)
